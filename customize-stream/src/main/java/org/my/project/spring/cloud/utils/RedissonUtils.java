package org.my.project.spring.cloud.utils;
...
public class RedissonUtils {
    ...
    public static RTopic<RemoteApplicationEvent> getTopic(String topicName) {
        return redissonClient.getTopic(topicName, new SerializationCodec());
    }
}
